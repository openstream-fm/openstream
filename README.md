...
![front app build](https://github.com/ramiroaisen/openstream-rs/actions/workflows/front-app-build.yml/badge.svg)
![front app typecheck](https://github.com/ramiroaisen/openstream-rs/actions/workflows/front-app-typecheck.yml/badge.svg)
