...
const locale: typeof import("./misc.en").default = {
  ...
  station_transfer_message_html: "Para transferir la estación @station a otra de tus cuentas, escribí el nombre de la estación: <b>@station</b> y elegí la cuenta de destino.",
  station_transfer_not_owner_message_html: "Solo los administradores de la cuenta pueden transferir estaciones entre cuentas. <br/> <br/>Contactá a los administradores de la cuenta para transferir la estación a otra cuenta.",
  station_transfer_no_targets_message: "Tenés que tener acceso a otra cuenta para poder transferir esta emisora a otra cuenta.",
