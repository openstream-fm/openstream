  ...
  <div class="meters">
    <div class="meter">
      ...
      <div class="meter-graph">
        <CircularMeter start={0} end={data.listeners.used / data.listeners.avail} />
      </div>
      <div class="meter-text">
        <span class="used">{data.listeners.used}</span>
        <span class="of">of</span>
        <span class="avail">{data.listeners.avail}</span>
      </div>
    </div>
    <div class="meter">
      <div class="meter-title">
      ...
      <div class="meter-graph">
        <CircularMeter start={0} end={data.bandwidth.used / data.bandwidth.avail} />
      </div>
      <div class="meter-text">
        <span class="used">{preetyBytes(data.bandwidth.used)}</span>
        <span class="of">of</span>
        <span class="avail">{preetyBytes(data.bandwidth.avail)}</span>
      </div>
    </div>
    <div class="meter">
      <div class="meter-title">
      ...
      <div class="meter-graph">
        <CircularMeter start={0} end={data.storage.used / data.storage.avail} />
      </div>
      <div class="meter-text">
        <span class="used">{preetyBytes(data.storage.used)}</span>
        <span class="of">of</span>
        <span class="avail">{preetyBytes(data.storage.avail)}</span>
      </div>
    </div>
  </div>
</Page>