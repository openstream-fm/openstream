...
use crate::{
  serde::attr::{parse_assign_inflection, parse_assign_str, Inflection},
  serde::util::{impl_parse, syn_err},
};
...
impl EnumAttr {
  ...
  pub fn from_attrs(attrs: &[Attribute]) -> Result<Self> {
    ...
    // #[cfg(feature = "serde-compat")]
    crate::serde::util::parse_serde_attrs::<SerdeEnumAttr>(attrs).for_each(|a| result.merge(a.0));
    Ok(result)
  }
