...
use hyper::{Version, Method, HeaderMap, header::HeaderName, http::HeaderValue};
  ...
  ($n:expr) => {
    {
      ...
      headers.append(::hyper::header::CONNECTION, ::hyper::header::HeaderValue::from_static("close"));
