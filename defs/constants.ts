...
export const VALIDATE_STATION_EXTERNAL_RELAY_URL_MAX_LEN = 2000;
...
export const VALIDATE_STATION_SLUG_MAX_LEN = 60;

export const VALIDATE_STATION_SLUG_MIN_LEN = 1;

export const VALIDATE_STATION_URLS_MAX_LEN = 200;
